...
var BackButton = /** @class */ (function () {
    function BackButton(hostRef) {
         ...
         */
        this.type = 'button';
        this.onClick = function (ev) { return __WEBPACK_IMPORTED_MODULE_0_tslib__["__awaiter"](_this, void 0, void 0, function () {
            var nav, _a;
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, Object(__WEBPACK_IMPORTED_MODULE_3__chunk_ba834eff_js__["d" /* o */])(this.defaultHref, ev, 'back')];
                }
            });
        }); };
    }
    Object.defineProperty(BackButton.prototype, "backButtonIcon", {
        get: function () {
            return this.icon != null ? this.icon : __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].get('backButtonIcon', 'arrow-back');
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(BackButton.prototype, "backButtonText", {
        get: function () {
            ...
            return this.text != null ? this.text : __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].get('backButtonText', defaultBackButtonText);
        },
        enumerable: true,
        configurable: true
    });
    ...
    BackButton.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], { onClick: this.onClick, class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_3__chunk_ba834eff_js__["a" /* c */])(color), (_a = {}, _a[mode] = true, _a['button'] = true, _a['back-button-disabled'] = disabled, _a['back-button-has-icon-only'] = hasIconOnly, _a['ion-activatable'] = true, _a['ion-focusable'] = true, _a['show-back-button'] = showBackButton, _a)) }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("button", { type: type, disabled: disabled, class: "button-native" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "button-inner" }, backButtonIcon && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-icon", { icon: backButtonIcon, lazy: false }), backButtonText && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "button-text" }, backButtonText)), mode === 'md' && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-ripple-effect", { type: this.rippleType }))));
    };
