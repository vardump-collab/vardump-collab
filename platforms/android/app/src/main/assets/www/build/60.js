...
var Chip = /** @class */ (function () {
    ...
    Chip.prototype.hostData = function () {
        ...
        return {
            class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_2__chunk_ba834eff_js__["a" /* c */])(this.color), (_a = {}, _a[mode] = true, _a['chip-outline'] = this.outline, _a['ion-activatable'] = true, _a))
        };
    };
    Chip.prototype.__stencil_render = function () {
        ...
        return [
            ...
            mode === 'md' ? Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("ion-ripple-effect", null) : null
        ];
    };
    Chip.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
