...
var VirtualScroll = /** @class */ (function () {
    ...
    VirtualScroll.prototype.updateVirtualScroll = function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["g" /* f */])(this.readVS.bind(this));
        Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["n" /* w */])(this.writeVS.bind(this));
    };
    ...
    VirtualScroll.prototype.__stencil_render = function () {
        var _this = this;
        if (this.renderItem) {
            return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map(function (node) { return _this.renderVirtualNode(node); })));
        }
        return undefined;
    };
    ...
    VirtualScroll.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
