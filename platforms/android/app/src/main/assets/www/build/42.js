...
var Button = /** @class */ (function () {
    function Button(hostRef) {
        ...
        this.handleClick = function (ev) {
            if (_this.type === 'button') {
                Object(__WEBPACK_IMPORTED_MODULE_2__chunk_ba834eff_js__["d" /* o */])(_this.href, ev, _this.routerDirection);
            }
            else if (Object(__WEBPACK_IMPORTED_MODULE_3__chunk_c90aaa66_js__["g" /* h */])(_this.el)) {
        ...
        this.ionFocus = Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["e" /* d */])(this, "ionFocus", 7);
        this.ionBlur = Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["e" /* d */])(this, "ionBlur", 7);
    }
    ...
    Button.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["a" /* H */], { onClick: this.handleClick, "aria-disabled": disabled ? 'true' : null, class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_2__chunk_ba834eff_js__["a" /* c */])(color), (_a = {}, _a[mode] = true, _a[buttonType] = true, _a[buttonType + "-" + expand] = expand !== undefined, _a[buttonType + "-" + finalSize] = finalSize !== undefined, _a[buttonType + "-" + shape] = shape !== undefined, _a[buttonType + "-" + fill] = true, _a[buttonType + "-strong"] = strong, _a['button-has-icon-only'] = hasIconOnly, _a['button-disabled'] = disabled, _a['ion-activatable'] = true, _a['ion-focusable'] = true, _a)) }, Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(TagType, Object.assign({}, attrs, { class: "button-native", disabled: disabled, onFocus: this.onFocus, onBlur: this.onBlur }), Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "button-inner" }, Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "icon-only" }), Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "start" }), Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("slot", null), Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "end" })), mode === 'md' && Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("ion-ripple-effect", { type: this.rippleType }))));
    };
...
var getNamedUrl = function (name) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["j" /* i */])("svg/" + name + ".svg");
};
...
var Icon = /** @class */ (function () {
    ...
    Icon.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["a" /* H */], { role: "img", class: Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color), (_b = {}, _b["icon-" + this.size] = !!this.size, _b['flip-rtl'] = !!flipRtl && this.el.ownerDocument.dir === 'rtl', _b)) }, ((this.svgContent)
            ? Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "icon-inner", innerHTML: this.svgContent })
            : Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "icon-inner" }))));
    };
...
var getIonMode = function (ref) {
    return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["k" /* j */])(ref) || document.documentElement.getAttribute('mode') || 'md';
};
