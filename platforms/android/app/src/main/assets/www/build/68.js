...
var ActionSheet = /** @class */ (function () {
    function ActionSheet(hostRef) {
         ...
         */
        this.animated = true;
        this.didPresent = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionActionSheetDidPresent", 7);
        this.willPresent = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionActionSheetWillPresent", 7);
        this.willDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionActionSheetWillDismiss", 7);
        this.didDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionActionSheetDidDismiss", 7);
    }
    ActionSheet.prototype.onBackdropTap = function () {
        this.dismiss(undefined, __WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["a" /* B */]);
    };
    ActionSheet.prototype.dispatchCancelHandler = function (ev) {
        var role = ev.detail.role;
        if (Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["j" /* i */])(role)) {
    ...
    ActionSheet.prototype.present = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["e" /* d */])(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
    };
    /**
    ...
    ActionSheet.prototype.dismiss = function (data, role) {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["f" /* e */])(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
    };
    /**
     * Returns a promise that resolves when the action sheet did dismiss.
     */
    ActionSheet.prototype.onDidDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["g" /* f */])(this.el, 'ionActionSheetDidDismiss');
    };
    /**
    ...
    ActionSheet.prototype.onWillDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["g" /* f */])(this.el, 'ionActionSheetWillDismiss');
    };
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["o" /* s */])(button.handler)];
                    case 1:
                        rtn = _a.sent();
                        if (rtn === false) {
    ...
    ActionSheet.prototype.hostData = function () {
        ...
        return {
            ...
            class: Object.assign((_a = {}, _a[mode] = true, _a), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["b" /* g */])(this.cssClass), { 'action-sheet-translucent': this.translucent })
        };
    };
    ActionSheet.prototype.__stencil_render = function () {
        ...
        return [
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-backdrop", { tappable: this.backdropDismiss }),
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "action-sheet-wrapper", role: "dialog" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "action-sheet-container" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "action-sheet-group" }, this.header !== undefined &&
                Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "action-sheet-title" }, this.header, this.subHeader && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "action-sheet-sub-title" }, this.subHeader)), buttons.map(function (b) { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("button", { type: "button", "ion-activatable": true, class: buttonClass(b), onClick: function () { return _this.buttonClick(b); } }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "action-sheet-button-inner" }, b.icon && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-icon", { icon: b.icon, lazy: false, class: "action-sheet-icon" }), b.text), mode === 'md' && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-ripple-effect", null)); })), cancelButton &&
                Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "action-sheet-group action-sheet-group-cancel" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("button", { type: "button", class: buttonClass(cancelButton), onClick: function () { return _this.buttonClick(cancelButton); } }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "action-sheet-button-inner" }, cancelButton.icon &&
                    Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-icon", { icon: cancelButton.icon, lazy: false, class: "action-sheet-icon" }), cancelButton.text)))))
        ];
    };
    ...
    ActionSheet.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
...
var buttonClass = function (button) {
    var _a;
    return Object.assign((_a = { 'action-sheet-button': true, 'ion-activatable': true }, _a["action-sheet-" + button.role] = button.role !== undefined, _a), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["b" /* g */])(button.cssClass));
};
