...
var Spinner = /** @class */ (function () {
    ...
    Spinner.prototype.getName = function () {
        var name = this.name || __WEBPACK_IMPORTED_MODULE_1__chunk_1074393c_js__["b"].get('spinner');
    ...
    Spinner.prototype.hostData = function () {
        ...
        var mode = Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["d" /* c */])(this);
        return {
            class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_2__chunk_ba834eff_js__["a" /* c */])(this.color), (_a = {}, _a[mode] = true, _a["spinner-" + this.getName()] = true, _a['spinner-paused'] = !!this.paused || __WEBPACK_IMPORTED_MODULE_1__chunk_1074393c_js__["b"].getBoolean('_testing'), _a))
        };
    };
    ...
    Spinner.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
...
var buildCircle = function (spinner, duration, index, total) {
    ...
    return (Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("svg", { viewBox: "0 0 64 64", style: data.style }, Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("circle", { transform: "translate(32,32)", r: data.r })));
};
var buildLine = function (spinner, duration, index, total) {
    var data = spinner.fn(duration, index, total);
    data.style['animation-duration'] = duration + "ms";
    return (Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("svg", { viewBox: "0 0 64 64", style: data.style }, Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
};
