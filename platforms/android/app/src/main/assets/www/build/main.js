...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__principal_principal__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__registro_cliente_registro_cliente__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__encuesta_de_empleado_encuesta_de_empleado__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__qr_ingreso_local_qr_ingreso_local__ = __webpack_require__(191);
...
var LoginPage = /** @class */ (function () {
                        ...
                        if (!data[item].logueado) {
                            ...
                            usuariosRef.child(item).update({
                                ...
                                switch (tipo) {
                                    ...
                                    case "metre":
                                    case "repartidor":
                                        _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_7__encuesta_de_empleado_encuesta_de_empleado__["a" /* EncuestaDeEmpleadoPage */]);
                                        break;
                                    case "cliente":
                                        if (estado == "espera")
                                            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__qr_ingreso_local_qr_ingreso_local__["a" /* QrIngresoLocalPage */]);
                                        else
    ...
    LoginPage.prototype.IngresarComoAnonimo = function () {
        ...
        this.authInstance.auth.signInWithEmailAndPassword("anonimo@yopmail.com", "123456").then(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_barcode_scanner__ = __webpack_require__(61);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_auth__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angularfire2_auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_barcode_scanner__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__principal_principal__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common_http__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QrIngresoLocalPage = /** @class */ (function () {
    function QrIngresoLocalPage(navCtrl, navParams, authInstance, barcodeScanner, camera, httpClient) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authInstance = authInstance;
        this.barcodeScanner = barcodeScanner;
        ...
        if (this.tieneReserva) {
            ...
            this.barcodeScanner.scan(this.options).then(function (barcodeData) {
                ...
                if (barcodeData.text === "bienvenido") {
                    ...
                    _this.httpClient.get("http://wirepusher.com/send?id=mpgtP&title=COMANDA&message=Una persona se ha anunciado")
                        .subscribe(function (data) {
                        console.log(data['_body']);
                    }, function (error) {
                        console.log(error);
                    });
                    _this.httpClient.get("http://wirepusher.com/send?id=mpgtm&title=COMANDA&message=Una persona se ha anunciado")
                        .subscribe(function (data) {
                        console.log(data['_body']);
                    }, function (error) {
                        console.log(error);
...
var PedirPlatosPage = /** @class */ (function () {
    function PedirPlatosPage(navCtrl, navParams, authInstance, alertCtrl, toastCtrl, httpClient) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authInstance = authInstance;
        this.alertCtrl = alertCtrl;
        ...
        if (parseInt(valor) <= 0 || valor == undefined || valor == "") {
            if (this.contErrores == 3) {
                ...
                setTimeout(function () {
                    _this.mostrarAlert3 = false;
                    _this.mensaje = "Su pedido ha sido enviado en breve se lo llevaremos...";
                    _this.httpClient.get("http://wirepusher.com/send?id=mpgtP&title=COMANDA&message=Una persona ha realizado un pedido")
                        .subscribe(function (data) {
                        console.log(data['_body']);
                    }, function (error) {
                        console.log(error);
                    });
                    _this.httpClient.get("http://wirepusher.com/send?id=mpgtm&title=COMANDA&message=Una persona ha realizado un pedido")
                        .subscribe(function (data) {
                        console.log(data['_body']);
                    }, function (error) {
                        console.log(error);
    ...
    PedirPlatosPage.prototype.PedirFinal = function () {
        ...
        if (!this.esDelivery) {
            ...
            usuariosRef.update({ estado: "delivery", cuenta: this.monto, direccion: this.direccion, localidad: this.localidad }).then(function () {
                ...
                _this.mostrarSpinner = false;
                _this.mensaje = "El pedido ha sido enviado en breve se lo llevaremos";
                _this.httpClient.get("http://wirepusher.com/send?id=mpgtP&title=COMANDA&message=Se ha generado un pedido por delivery")
                    .subscribe(function (data) {
                    console.log(data['_body']);
                }, function (error) {
                    console.log(error);
                });
                _this.httpClient.get("http://wirepusher.com/send?id=mpgtm&title=COMANDA&message=Se ha generado un pedido por delivery")
                    .subscribe(function (data) {
                    console.log(data['_body']);
                }, function (error) {
                    console.log(error);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_barcode_scanner__ = __webpack_require__(61);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__encuesta_supervisor_encuesta_supervisor__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_firebase_firestore__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_chart_js__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_chart_js__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_common_http__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReservaPage = /** @class */ (function () {
    function ReservaPage(navCtrl, navParams, toastCtrl, httpClient) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.toastCtrl = toastCtrl;
        this.httpClient = httpClient;
                    ...
                    mesasRef.once("value", function (snap) {
                        ...
                        if (puedeReservar) {
                            reservasRef.push({
                                ...
                                _this.httpClient.get("http://wirepusher.com/send?id=mpgtP&title=COMANDA&message=Un cliente ha solicitado una reserva")
                                    .subscribe(function (data) {
                                    console.log(data['_body']);
                                }, function (error) {
                                    console.log(error);
                                });
                                _this.httpClient.get("http://wirepusher.com/send?id=mpgtm&title=COMANDA&message=Un cliente ha solicitado una reserva")
                                    .subscribe(function (data) {
                                    console.log(data['_body']);
                                }, function (error) {
                                    console.log(error);
    ...
    ReservaPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ToastController */], __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["a" /* HttpClient */]])
    ], ReservaPage);
    return ReservaPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_barcode_scanner__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__principal_principal__ = __webpack_require__(67);
...
var CuentaPage = /** @class */ (function () {
    function CuentaPage(navCtrl, navParams, barcodeScanner, toastCtrl, httpClient) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.barcodeScanner = barcodeScanner;
        ...
        usuariosRef.once("value", function (snap) {
            ...
            pedidoRef.once("value", function (snap) {
                ...
                for (var _i = 0, _a = _this.pedidos; _i < _a.length; _i++) {
                    var item = _a[_i];
                    _this.subTotal += item.precio * item.cantidad;
                }
                ...
                console.log("TOTAL 1: ", _this.total);
                if (data.desc) {
                    _this.descuento = _this.subTotal * 0.1;
                    _this.total = _this.subTotal -= _this.descuento;
                }
                console.log("TOTAL 2: ", _this.total);
                _this.estado = "cuenta";
                _this.ocultarSpinner = true;
            }).catch(function () { return _this.presentToast("Ups... Tenemos problemas técnicos."); });
        }).catch(function () { return _this.presentToast("Ups... Tenemos problemas técnicos."); });
        ...
        if (this.textoDelBoton == "Verificar mesa") {
            ...
            pedidoRef.update({ estado: estadoPedido_1 }).then(function () {
                clienteRef_1.update({ estado: estadoPedido_1, cuenta: _this.total }).then(function () {
                    _this.MostrarAlert("Éxito!", "Aguarde la confirmación, nos ayudaría mucho que completases una encuesta sobre tu experiencia en el lugar.", "Ok", _this.Redireccionar);
                    _this.ocultarSpinner = true;
                    _this.httpClient.get("http://wirepusher.com/send?id=mpgtP&title=COMANDA&message=Un cliente ha pagado su cuenta")
                        .subscribe(function (data) {
                        console.log(data['_body']);
                    }, function (error) {
                        console.log(error);
                    });
                    _this.httpClient.get("http://wirepusher.com/send?id=mpgtm&title=COMANDA&message=Un cliente ha pagado su cuenta")
                        .subscribe(function (data) {
                        console.log(data['_body']);
                    }, function (error) {
                        console.log(error);
    ...
    CuentaPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ToastController */], __WEBPACK_IMPORTED_MODULE_5__angular_common_http__["a" /* HttpClient */]])
    ], CuentaPage);
    return CuentaPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__juego_dos_juego_dos__ = __webpack_require__(230);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_native_audio__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_firebase__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_native_audio__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_firebase__);
...
var JuegoDosPage = /** @class */ (function () {
    ...
    JuegoDosPage.prototype.Timer = function () {
        ...
        this.asd = setInterval(function () {
            _this.segundos--;
            if (_this.segundos == 0) {
                _this.MostrarAlert("¡Perdió!", "Se le acabó el tiempo para responder.", "Aceptar", _this.limpiarJuego);
    ...
    JuegoDosPage.prototype.limpiarJuego = function () {
        this.ocultarAlert = true;
        this.navCtrl.pop();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_barcode_scanner__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__encuesta_de_empleado_encuesta_de_empleado__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__angular_common_http__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QrDeLaMesaPage = /** @class */ (function () {
    function QrDeLaMesaPage(navCtrl, navParams, toastCtrl, authInstance, barcode, httpClient) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.toastCtrl = toastCtrl;
        ...
        genteRef.on("value", function (snap) {
            ...
            _this.ParaValidar = _this.usuarios.filter(function (item) {
                if (item.estado == "pidio") {
                    _this.sinPedidosValidar = true;
                    var mensaje_1 = "";
                    var ped = _this.firebase.database().ref("pedidos/" + item.mesa).on("value", function (snap) {
                        ...
                        if (mensaje_1 != "") {
                            console.log("mensaje", mensaje_1);
                            _this.mensajeValidar.push(mensaje_1);
                            mensaje_1 = "";
                        }
                        return false;
                    });
                    console.log("mensaje validar", _this.mensajeValidar);
                    /*let val = snap.val();
                    console.log("val", val);
                    for(let item of val){
                      console.log("item", item);
...
*/
                                                ...
                                                mesaRef.child(item).update({ estado: "libre" }).then(function () {
                                                    mesaRef.child(item).child("cliente").remove().then(function () {
                                                        mesaRef.child(item).child("tiempoMinimo").remove().then(function () {
                                                            ...
                                                            _this.httpClient.get("http://wirepusher.com/send?id=mpgtP&title=COMANDA&message=Un pago ha sido confirmado")
                                                                .subscribe(function (data) {
                                                                console.log(data['_body']);
                                                            }, function (error) {
                                                                console.log(error);
                                                            });
                                                            _this.httpClient.get("http://wirepusher.com/send?id=mpgtm&title=COMANDA&message=Un pago ha sido confirmado")
                                                                .subscribe(function (data) {
                                                                console.log(data['_body']);
                                                            }, function (error) {
                                                                console.log(error);
    ...
    QrDeLaMesaPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ToastController */], __WEBPACK_IMPORTED_MODULE_5_angularfire2_auth__["AngularFireAuth"], __WEBPACK_IMPORTED_MODULE_6__ionic_native_barcode_scanner__["a" /* BarcodeScanner */], __WEBPACK_IMPORTED_MODULE_10__angular_common_http__["a" /* HttpClient */]])
    ], QrDeLaMesaPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2_auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__encuesta_de_empleado_encuesta_de_empleado__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser___ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MapaDeRutaPage = /** @class */ (function () {
    function MapaDeRutaPage(navCtrl, navParams, alert, authInstance, sanitizer) {
        //this.authInstance.auth.signInWithEmailAndPassword("example@gmail.com", "123456");
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    MapaDeRutaPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser___["c" /* DomSanitizer */]])
    ], MapaDeRutaPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_splash_screen__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_native_audio__ = __webpack_require__(79);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_alta_duenio_supervisor_alta_duenio_supervisor__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_alta_empleado_alta_empleado__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_listado_supervisor_listado_supervisor__ = __webpack_require__(221);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_registro_cliente_registro_cliente__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_alta_platos_alta_platos__ = __webpack_require__(466);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_qr_ingreso_local_qr_ingreso_local__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_encuesta_cliente_encuesta_cliente__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_pedir_platos_pedir_platos__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_alta_de_mesa_alta_de_mesa__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_qr_de_la_mesa_qr_de_la_mesa__ = __webpack_require__(232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_tomar_pedido_tomar_pedido__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_mapa_de_ruta_mapa_de_ruta__ = __webpack_require__(234);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VerificarTipoProvider = /** @class */ (function () {
    ...
    VerificarTipoProvider.prototype.RetornarAcciones = function () {
        ...
        switch (usuario.tipo) {
            ...
            case "mozo":
                acciones = [
                    { accion: "Gestionar Mesas", img: "ocupar-mesa.jpg", ruta: __WEBPACK_IMPORTED_MODULE_14__pages_qr_de_la_mesa_qr_de_la_mesa__["a" /* QrDeLaMesaPage */] },
            ...
            case "cliente":
                acciones = [
                    /*0*/ { accion: "Pagar", img: "propina.jpg", ruta: __WEBPACK_IMPORTED_MODULE_5__pages_cuenta_cuenta__["a" /* CuentaPage */] },
                    /*1*/ { accion: "Ingresar al local", img: "entrada.jpg", ruta: __WEBPACK_IMPORTED_MODULE_10__pages_qr_ingreso_local_qr_ingreso_local__["a" /* QrIngresoLocalPage */] },
                    /*2*/ { accion: "Ver estado del pedido", img: "estado-pedido.jpg", ruta: __WEBPACK_IMPORTED_MODULE_14__pages_qr_de_la_mesa_qr_de_la_mesa__["a" /* QrDeLaMesaPage */] },
                    /*3*/ { accion: "Hacer un pedido", img: "pedido.jpg", ruta: __WEBPACK_IMPORTED_MODULE_12__pages_pedir_platos_pedir_platos__["a" /* PedirPlatosPage */] },
                    /*4*/ { accion: "Realizar encuesta", img: "encuesta.jpg", ruta: __WEBPACK_IMPORTED_MODULE_11__pages_encuesta_cliente_encuesta_cliente__["a" /* EncuestaClientePage */] },
                    /*5*/ { accion: "Reservar", img: "reserva.jpg", ruta: __WEBPACK_IMPORTED_MODULE_4__pages_reserva_reserva__["a" /* ReservaPage */] },
                    /*6*/ { accion: "Juegos", img: "juegos.jpg", ruta: __WEBPACK_IMPORTED_MODULE_7__pages_sala_de_juegos_sala_de_juegos__["a" /* SalaDeJuegosPage */] },
                    /*7*/ { accion: "Hablar con el repartidor", img: "chat.jpg", ruta: __WEBPACK_IMPORTED_MODULE_16__pages_mapa_de_ruta_mapa_de_ruta__["a" /* MapaDeRutaPage */] }
                ];
                break;
            case "anonimo":
                acciones = [
                    /*0*/ { accion: "Pagar", img: "propina.jpg", ruta: __WEBPACK_IMPORTED_MODULE_5__pages_cuenta_cuenta__["a" /* CuentaPage */] },
                    /*1*/ { accion: "Ver estado del pedido", img: "estado-pedido.jpg", ruta: __WEBPACK_IMPORTED_MODULE_14__pages_qr_de_la_mesa_qr_de_la_mesa__["a" /* QrDeLaMesaPage */] },
                    /*2*/ { accion: "Hacer un pedido", img: "pedido.jpg", ruta: __WEBPACK_IMPORTED_MODULE_12__pages_pedir_platos_pedir_platos__["a" /* PedirPlatosPage */] },
                    /*3*/ { accion: "Realizar encuesta.", img: "encuesta.jpg", ruta: __WEBPACK_IMPORTED_MODULE_11__pages_encuesta_cliente_encuesta_cliente__["a" /* EncuestaClientePage */] },
                    /*4*/ { accion: "Juegos", img: "juegos.jpg", ruta: __WEBPACK_IMPORTED_MODULE_7__pages_sala_de_juegos_sala_de_juegos__["a" /* SalaDeJuegosPage */] }
                ];
                break;
        }
        return acciones;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angularfire2_auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pedir_platos_pedir_platos__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_chart_js__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_chart_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_login__ = __webpack_require__(15);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_component__ = __webpack_require__(795);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_native_audio__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_about_about__ = __webpack_require__(512);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_contact_contact__ = __webpack_require__(513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_home_home__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_tabs_tabs__ = __webpack_require__(796);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_principal_principal__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_alta_duenio_supervisor_alta_duenio_supervisor__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_perfil_perfil__ = __webpack_require__(235);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_alta_empleado_alta_empleado__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_encuesta_supervisor_encuesta_supervisor__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_listado_supervisor_listado_supervisor__ = __webpack_require__(221);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_registro_cliente_registro_cliente__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_alta_platos_alta_platos__ = __webpack_require__(466);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_qr_ingreso_local_qr_ingreso_local__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_encuesta_cliente_encuesta_cliente__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_pedir_platos_pedir_platos__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_status_bar__ = __webpack_require__(511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__ionic_native_splash_screen__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_splash_splash__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_alta_de_mesa_alta_de_mesa__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_encuesta_de_empleado_encuesta_de_empleado__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_qr_de_la_mesa_qr_de_la_mesa__ = __webpack_require__(232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_tomar_pedido_tomar_pedido__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__angular_http__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35_ng2_charts__ = __webpack_require__(798);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_mapa_de_ruta_mapa_de_ruta__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__ionic_native_camera__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__ionic_native_barcode_scanner__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__providers_verificar_tipo_verificar_tipo__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40_angularfire2__ = __webpack_require__(800);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__config__ = __webpack_require__(801);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43_angularfire2_firestore__ = __webpack_require__(470);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__ionic_native_firebase__ = __webpack_require__(469);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_juego_juego__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__providers_fcm_fcm__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pipes_el_el__ = __webpack_require__(802);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__components_components_module__ = __webpack_require__(803);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49_ionic2_rating__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__pages_juego_dos_juego_dos__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__pipes_tiempo_desde_ahora_tiempo_desde_ahora__ = __webpack_require__(807);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__providers_ruteo_ruteo__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__angular_common_http__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_verificar_tipo_verificar_tipo__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__perfil_perfil__ = __webpack_require__(235);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_native_audio__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_firebase_firestore__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_fcm_fcm__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_operators__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__encuesta_de_empleado_encuesta_de_empleado__ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_chart_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__principal_principal__ = __webpack_require__(67);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_splash_splash__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_login_login__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_principal_principal__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_fcm_fcm__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_native_audio__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_common_http__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen, modalCtrl, fcm, toastCtrl, nativeAudio, httpClient) {
        var _this = this;
        this.nativeAudio = nativeAudio;
        this.httpClient = httpClient;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__about_about__ = __webpack_require__(512);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contact_contact__ = __webpack_require__(513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home_home__ = __webpack_require__(514);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\Fede\Desktop\vardump-collab\src\pages\tabs\tabs.html"*/'<ion-tabs>\n\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n\n</ion-tabs>\n\n'/*ion-inline-end:"C:\Users\Fede\Desktop\vardump-collab\src\pages\tabs\tabs.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], TabsPage);
    return TabsPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__spinner_spinner__ = __webpack_require__(804);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
