...
var AltaEmpleadoPage = /** @class */ (function () {
    ...
    AltaEmpleadoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-alta-empleado',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\alta-empleado\alta-empleado.html"*/'<ion-header>\n\n  <ion-navbar color="dark">\n\n\n\n    <!-- <ion-title>{{usuario.tipo}}</ion-title> -->\n\n\n\n    <ion-buttons end>\n\n      <button ion-button (click)="Logout()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<div [ngClass]="{\'alert\':true,\'ocultar\':ocultarAlert}">\n\n\n\n  <div class="alert-message animation-target">\n\n    <h1>{{alertTitulo}}</h1>\n\n    <p>{{alertMensaje}}</p>\n\n    <div class="botones">\n\n\n\n      <button ion-button outline (click)="alertHandler()">{{alertMensajeBoton}}</button>\n\n    </div>\n\n  </div>\n\n\n\n</div>\n\n\n\n<ion-content [ngClass]="{\'ocultar-fondo\': estado == \'ocultar\'}">\n\n\n\n  <div class="vertical-container">\n\n\n\n    <img src="../../assets/imgs/alfa/logo.png">\n\n\n\n    <h1>Registro</h1>\n\n\n\n    <h2>Agregar un empleado</h2>\n\n\n\n    <input type="text" placeholder="Correo electrónico" [(ngModel)]="correo" />\n\n    <input type="text" placeholder="Nombre" [(ngModel)]="nombre" />\n\n    <input type="text" placeholder="Apellido" [(ngModel)]="apellido" />\n\n\n\n    <div class="header" style="width: 75%;margin: 20px 0 20px 0;">\n\n      <input type="text" placeholder="DNI" style="margin: 0 15px 0 0; width: 50%" [(ngModel)]="dni" />\n\n      <input type="text" placeholder="CUIL" style="margin: 0;width: 50%" [(ngModel)]="cuil" />\n\n    </div>\n\n\n\n    <input type="password" placeholder="Contraseña" [(ngModel)]="clave" />\n\n\n\n    <select [(ngModel)]="tipo">\n\n      <option value="mozo">Mozo</option>\n\n      <option value="cocinero">Cocinero</option>\n\n      <option value="bartender">Bartender</option>\n\n      <option value="metre">Metre</option>\n\n      <option value="repartidor">Repartidor</option>\n\n    </select>\n\n\n\n    <img [src]="foto" alt="">\n\n\n\n    <div class="header" style="width: 75%;margin: 20px 0 20px 0;">\n\n      <button ion-button color="dark" class="alta" style="margin: 0 30px 0 0;width: 50%" (click)="SacarFoto()">Sacar\n\n        foto</button>\n\n      <button ion-button color="dark" class="alta" style="margin: 0;width: 50%" (click)="InicializarLectorQR()">QR</button>\n\n\n\n    </div>\n\n\n\n    <button ion-button color="dark" [disabled]="estadoBoton" class="alta" (click)="Registrar()">Registrar</button>\n\n  </div>\n\n\n\n  <button ion-button color="dark" class="close" (click)="OcultarLectorQR()">\n\n    <ion-icon name="close"></ion-icon>\n\n  </button>\n\n\n\n  <app-spinner [ngClass]="{\'ocultar\':!estadoBoton}"></app-spinner>\n\n\n\n</ion-content>'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\alta-empleado\alta-empleado.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3_angularfire2_auth__["AngularFireAuth"],
...
var SalaDeJuegosPage = /** @class */ (function () {
    ...
    SalaDeJuegosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-sala-de-juegos',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\sala-de-juegos\sala-de-juegos.html"*/'<ion-header>\n\n  <ion-navbar color="dark">\n\n\n\n    <!-- <ion-title>{{usuario.tipo}}</ion-title> -->\n\n\n\n    <ion-buttons end *ngIf="usuario.tipo != \'anonimo\'">\n\n      <button ion-button (click)="Logout()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-nav #content swipeBackEnabled="false"></ion-nav>\n\n\n\n<ion-content class="card-background-page" padding>\n\n\n\n  <button ion-button *ngFor="let item of juegos" (click)="Redireccionar(item.ruta)">\n\n    <div class="sombreado"></div>\n\n    <img src="../../assets/imgs/alfa/{{item.img}}" />\n\n    <span>{{item.accion}}</span>\n\n  </button>\n\n\n\n</ion-content>'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\sala-de-juegos\sala-de-juegos.html"*/,
        }),
        ...
        ref.once('value', function (snap) {
            ...
            for (var key in data) {
                if (mesa == data[key].mesa) {
                    ...
                    ref.child(key).update(data[key]);
                    //alert("Listo,se relaciono al cliente con la mesa " + text);
                    _this.MostrarAlert("Éxito!", "Se acepto el pedido de la mesa." + mesa, "Aceptar", _this.limpiar);
                    //this.navCtrl.setRoot(this.navCtrl.getActive().component);
                    //COMENTE ESTO
                    return;
                }
                ...
                if (data[item].estado == "delivery") {
                    ...
                    probandoRef.once("value", function (snap) {
                        ...
                        var _loop_2 = function (a) {
                            ...
                            refU = _this.firebase.database().ref("usuarios");
                            refU.once('value', function (snap) {
                                var data = snap.val();
                                for (var item in data) {
                                    if (pruebita == data[item].correo) {
                                        _this.direccion = data[item].direccion.replace(" ", "%20");
                                        _this.localidad = data[item].localidad.replace(" ", "%20");
                                        _this.url = 'https://www.google.com/maps/embed/v1/directions?key=AIzaSyB63D2az3Guib3VGk7Auoie1fyG3lY1SzQ&origin=mitre%20750&destination=' + _this.direccion + ',%20' + _this.localidad;
                                        console.log("url", _this.url);
                                        _this.urlSanit = sanitizer.bypassSecurityTrustUrl(_this.url);
                                        break;
                                    }
                                    ;
                                }
...
var SplashPage = /** @class */ (function () {
    ...
    SplashPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-splash',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\splash\splash.html"*/'<!--\n\n  Generated template for the SplashPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<!--<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>splash</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>-->\n\n\n\n<ion-content class="parent">\n\n \n\n  <!--<img class="image2" src="assets/imgs/gamma/dssda.jpg">-->\n\n \n\n  <img class="image" src="assets/imgs/gamma/imagen.png">\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\splash\splash.html"*/,
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\about\about.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>\n\n      About\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\about\about.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
    ], AboutPage);
    return AboutPage;
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-contact',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\contact\contact.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>\n\n      Contact\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n\n    <ion-item>\n\n      <ion-icon name="ionic" item-start></ion-icon>\n\n      @ionicframework\n\n    </ion-item>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\contact\contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <h2>Welcome to Ionic!</h2>\n\n  <p>\n\n    This starter project comes with simple tabs-based layout for apps\n\n    that are going to primarily use a Tabbed UI.\n\n  </p>\n\n  <p>\n\n    Take a look at the <code>src/pages/</code> directory to add or change tabs,\n\n    update any existing page or create new pages.\n\n  </p>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
    ], HomePage);
    return HomePage;
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\tabs\tabs.html"*/'<ion-tabs>\n\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n\n</ion-tabs>\n\n'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\pages\tabs\tabs.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], TabsPage);
    return TabsPage;
...
var SpinnerComponent = /** @class */ (function () {
    ...
    SpinnerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-spinner',template:/*ion-inline-start:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\components\spinner\spinner.html"*/'<img src="assets/imgs/spinner.gif" />'/*ion-inline-end:"C:\Users\javii\Documents\VarDumpCollab\vardump-collab\src\components\spinner\spinner.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], SpinnerComponent);
