...
var AltaEmpleadoPage = /** @class */ (function () {
    ...
    AltaEmpleadoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-alta-empleado',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/alta-empleado/alta-empleado.html"*/'<ion-header>\n  <ion-navbar color="dark">\n\n    <!-- <ion-title>{{usuario.tipo}}</ion-title> -->\n\n    <ion-buttons end>\n      <button ion-button (click)="Logout()">\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-buttons>\n\n  </ion-navbar>\n</ion-header>\n\n<div [ngClass]="{\'alert\':true,\'ocultar\':ocultarAlert}">\n\n  <div class="alert-message animation-target">\n    <h1>{{alertTitulo}}</h1>\n    <p>{{alertMensaje}}</p>\n    <div class="botones">\n\n      <button ion-button outline (click)="alertHandler()">{{alertMensajeBoton}}</button>\n    </div>\n  </div>\n\n</div>\n\n<ion-content [ngClass]="{\'ocultar-fondo\': estado == \'ocultar\'}">\n\n  <div class="vertical-container">\n\n    <img src="../../assets/imgs/alfa/logo.png">\n\n    <h1>Registro</h1>\n\n    <h2>Agregar un empleado</h2>\n\n    <input type="text" placeholder="Correo electrónico" [(ngModel)]="correo" />\n    <input type="text" placeholder="Nombre" [(ngModel)]="nombre" />\n    <input type="text" placeholder="Apellido" [(ngModel)]="apellido" />\n\n    <div class="header" style="width: 75%;margin: 20px 0 20px 0;">\n      <input type="text" placeholder="DNI" style="margin: 0 15px 0 0; width: 50%" [(ngModel)]="dni" />\n      <input type="text" placeholder="CUIL" style="margin: 0;width: 50%" [(ngModel)]="cuil" />\n    </div>\n\n    <input type="password" placeholder="Contraseña" [(ngModel)]="clave" />\n\n    <select [(ngModel)]="tipo">\n      <option value="mozo">Mozo</option>\n      <option value="cocinero">Cocinero</option>\n      <option value="bartender">Bartender</option>\n      <option value="metre">Metre</option>\n      <option value="repartidor">Repartidor</option>\n    </select>\n\n    <img [src]="foto" alt="">\n\n    <div class="header" style="width: 75%;margin: 20px 0 20px 0;">\n      <button ion-button color="dark" class="alta" style="margin: 0 30px 0 0;width: 50%" (click)="SacarFoto()">Sacar\n        foto</button>\n      <button ion-button color="dark" class="alta" style="margin: 0;width: 50%" (click)="InicializarLectorQR()">QR</button>\n\n    </div>\n\n    <button ion-button color="dark" [disabled]="estadoBoton" class="alta" (click)="Registrar()">Registrar</button>\n  </div>\n\n  <button ion-button color="dark" class="close" (click)="OcultarLectorQR()">\n    <ion-icon name="close"></ion-icon>\n  </button>\n\n  <app-spinner [ngClass]="{\'ocultar\':!estadoBoton}"></app-spinner>\n\n</ion-content>'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/alta-empleado/alta-empleado.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3_angularfire2_auth__["AngularFireAuth"],
...
var SalaDeJuegosPage = /** @class */ (function () {
    ...
    SalaDeJuegosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-sala-de-juegos',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/sala-de-juegos/sala-de-juegos.html"*/'<ion-header>\n  <ion-navbar color="dark">\n\n    <!-- <ion-title>{{usuario.tipo}}</ion-title> -->\n\n    <ion-buttons end *ngIf="usuario.tipo != \'anonimo\'">\n      <button ion-button (click)="Logout()">\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-buttons>\n\n  </ion-navbar>\n</ion-header>\n\n<ion-nav #content swipeBackEnabled="false"></ion-nav>\n\n<ion-content class="card-background-page" padding>\n\n  <button ion-button *ngFor="let item of juegos" (click)="Redireccionar(item.ruta)">\n    <div class="sombreado"></div>\n    <img src="../../assets/imgs/alfa/{{item.img}}" />\n    <span>{{item.accion}}</span>\n  </button>\n\n</ion-content>'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/sala-de-juegos/sala-de-juegos.html"*/,
        }),
...
var SplashPage = /** @class */ (function () {
    ...
    SplashPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-splash',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/splash/splash.html"*/'<!--\n  Generated template for the SplashPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<!--<ion-header>\n\n  <ion-navbar>\n    <ion-title>splash</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>-->\n\n<ion-content class="parent">\n \n  <!--<img class="image2" src="assets/imgs/gamma/dssda.jpg">-->\n \n  <img class="image" src="assets/imgs/gamma/imagen.png">\n\n</ion-content>\n'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/splash/splash.html"*/,
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-about',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/about/about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/about/about.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
    ], AboutPage);
    return AboutPage;
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-contact',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/contact/contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/contact/contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-home',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h2>Welcome to Ionic!</h2>\n  <p>\n    This starter project comes with simple tabs-based layout for apps\n    that are going to primarily use a Tabbed UI.\n  </p>\n  <p>\n    Take a look at the <code>src/pages/</code> directory to add or change tabs,\n    update any existing page or create new pages.\n  </p>\n</ion-content>\n'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
    ], HomePage);
    return HomePage;
...
var MapPage = /** @class */ (function () {
    ...
    MapPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-map',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/map/map.html"*/'	<h1>{{destino}}</h1>\n	<h1>{{urlMapa}}</h1>\n        <div class="mapouter" *ngIf="!sinPedidos">\n          <div class="gmap_canvas">\n            <iframe width="600" height="500" id="gmap_canvas" \n              [attr.src]="urlMapa"\n              frameborder="0" scrolling="no" marginheight="0" marginwidth="0">\n            </iframe>Google Maps by ASGARDIANOS</div>\n            <style>\n              .mapouter{\n                position:relative;\n                text-align:right;\n                height:500px;\n                width:600px;\n                }\n              .gmap_canvas {\n                overflow:hidden;\n                background:none!important;\n                height:500px;\n                width:600px;\n              }\n            </style>\n      </div>'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/map/map.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_component__ = __webpack_require__(789);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_tabs_tabs__ = __webpack_require__(790);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__angular_http__ = __webpack_require__(791);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35_ng2_charts__ = __webpack_require__(792);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40_angularfire2__ = __webpack_require__(794);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__config__ = __webpack_require__(795);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pipes_el_el__ = __webpack_require__(796);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49_ionic2_rating__ = __webpack_require__(799);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__pages_juego_dos_juego_dos__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__pipes_tiempo_desde_ahora_tiempo_desde_ahora__ = __webpack_require__(801);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__providers_ruteo_ruteo__ = __webpack_require__(802);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__pages_map_map__ = __webpack_require__(515);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/app/app.html"*/
        }),
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/pages/tabs/tabs.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], TabsPage);
    return TabsPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__spinner_spinner__ = __webpack_require__(798);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SpinnerComponent = /** @class */ (function () {
    ...
    SpinnerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-spinner',template:/*ion-inline-start:"/home/linux/EndOfTheLine/vardump-collab-delta/src/components/spinner/spinner.html"*/'<img src="assets/imgs/spinner.gif" />'/*ion-inline-end:"/home/linux/EndOfTheLine/vardump-collab-delta/src/components/spinner/spinner.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], SpinnerComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(803);
