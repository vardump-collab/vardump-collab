...
var ProgressBar = /** @class */ (function () {
    ...
    ProgressBar.prototype.hostData = function () {
        ...
        var paused = __WEBPACK_IMPORTED_MODULE_1__chunk_1074393c_js__["b"].getBoolean('_testing');
        ...
        return {
            ...
            'aria-valuemin': 0,
            'aria-valuemax': 1,
            class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_2__chunk_ba834eff_js__["a" /* c */])(color), (_a = {}, _a[mode] = true, _a["progress-bar-" + type] = true, _a['progress-paused'] = paused, _a['progress-bar-reversed'] = document.dir === 'rtl' ? !reversed : reversed, _a))
        };
    };
    ProgressBar.prototype.__stencil_render = function () {
        if (this.type === 'indeterminate') {
            return [
                Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "indeterminate-bar-primary" }, Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "progress-indeterminate" })),
                Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "indeterminate-bar-secondary" }, Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("span", { class: "progress-indeterminate" }))
            ];
        }
        var value = Object(__WEBPACK_IMPORTED_MODULE_3__chunk_c90aaa66_js__["c"])(0, this.value, 1);
        var buffer = Object(__WEBPACK_IMPORTED_MODULE_3__chunk_c90aaa66_js__["c"])(0, this.buffer, 1);
        return [
            Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "progress", style: { transform: "scaleX(" + value + ")" } }),
            buffer !== 1 && Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "buffer-circles" }),
            Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "progress-buffer-bar", style: { transform: "scaleX(" + buffer + ")" } }),
        ];
    };
    ProgressBar.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
