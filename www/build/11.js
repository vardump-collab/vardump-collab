...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__chunk_00265c49_js__ = __webpack_require__(768);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__ = __webpack_require__(769);
...
var ViewController = /** @class */ (function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__chunk_00265c49_js__["a"])(this.delegate, container, component, ['ion-page', 'ion-page-invisible'], this.params)];
                    case 1:
                        _a.element = _b.sent();
                        _b.label = 2;
    ...
    ViewController.prototype._destroy = function () {
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
var Nav = /** @class */ (function () {
    ...
    Nav.prototype.componentWillLoad = function () {
        ...
        if (this.swipeGesture === undefined) {
            ...
            this.swipeGesture = __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('swipeBackEnabled', mode === 'ios');
        }
    ...
    Nav.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_3__chunk_94c4865f_js__["e" /* d */]);
            view._destroy();
        }
        if (this.gesture) {
        ...
        var commonOpts = {
            ...
            viewIsReady: function (enteringEl) {
                ...
                resolve({
                    changed: true,
                    element: enteringEl,
                    markVisible: function () { return __WEBPACK_IMPORTED_MODULE_0_tslib__["__awaiter"](_this, void 0, void 0, function () {
    ...
    Nav.prototype.prepareTI = function (ti) {
        ...
        if (ti.removeView !== undefined) {
            Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(ti.removeStart !== undefined, 'removeView needs removeStart');
            Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(ti.removeCount !== undefined, 'removeView needs removeCount');
        ...
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(insertViews.length > 0, 'length can not be zero');
    ...
    Nav.prototype.postViewInit = function (enteringView, leavingView, ti) {
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(leavingView || enteringView, 'Both leavingView and enteringView are null');
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(ti.resolve, 'resolve must be valid');
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(ti.reject, 'reject must be valid');
        var opts = ti.opts;
        var insertViews = ti.insertViews;
        var removeStart = ti.removeStart;
        ...
        if (removeStart !== undefined && removeCount !== undefined) {
            Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(removeStart >= 0, 'removeStart can not be negative');
            Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(removeCount >= 0, 'removeCount can not be negative');
            destroyQueue = [];
        ...
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(finalBalance >= 0, 'final balance can not be negative');
        if (finalBalance === 0) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_3__chunk_94c4865f_js__["c" /* b */]);
                Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_3__chunk_94c4865f_js__["d" /* c */]);
                Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_3__chunk_94c4865f_js__["e" /* d */]);
            }
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        animationOpts = Object.assign({ mode: mode, showGoBack: this.canGoBackSync(enteringView), baseEl: this.el, animationBuilder: this.animation || opts.animationBuilder || __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].get('navAnimation'), progressCallback: progressCallback, animated: this.animated && __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('animated', true), enteringEl: enteringEl,
                            leavingEl: leavingEl }, opts);
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["d" /* t */])(animationOpts)];
                    case 1:
    ...
    Nav.prototype.insertViewAt = function (view, index) {
        ...
        if (existingIndex > -1) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(view.nav === this, 'view is not part of the nav');
            views.splice(index, 0, views.splice(existingIndex, 1)[0]);
        }
        else {
            Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(!view.nav, 'nav is used');
    ...
    Nav.prototype.removeView = function (view) {
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
        var views = this.views;
        var index = views.indexOf(view);
        Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["b"])(index > -1, 'view must be part of the stack');
        if (index >= 0) {
    ...
    Nav.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["b" /* l */])(element, __WEBPACK_IMPORTED_MODULE_3__chunk_94c4865f_js__["e" /* d */]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(__WEBPACK_IMPORTED_MODULE_6__chunk_638b009b_js__["c" /* s */])(element, true);
            }
        }
    };
