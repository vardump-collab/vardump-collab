...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_3a9dcfed_js__ = __webpack_require__(766);
...
var Backdrop = /** @class */ (function () {
    function Backdrop(hostRef) {
        ...
        this.blocker = __WEBPACK_IMPORTED_MODULE_2__index_3a9dcfed_js__["GESTURE_CONTROLLER"].createBlocker({
            disableScroll: true
        });
        /**
        ...
        this.ionBackdropTap = Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["e" /* d */])(this, "ionBackdropTap", 7);
    }
    ...
    Backdrop.prototype.onTouchStart = function (ev) {
        this.lastClick = Object(__WEBPACK_IMPORTED_MODULE_3__chunk_c90aaa66_js__["i" /* n */])(ev);
        this.emitTap(ev);
    };
    Backdrop.prototype.onMouseDown = function (ev) {
        if (this.lastClick < Object(__WEBPACK_IMPORTED_MODULE_3__chunk_c90aaa66_js__["i" /* n */])(ev) - 2500) {
            this.emitTap(ev);
        }
    };
    ...
    Backdrop.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_09ec7fc0_js__["a" /* H */], this.hostData()); };
