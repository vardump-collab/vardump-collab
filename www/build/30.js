...
var Range = /** @class */ (function () {
    function Range(hostRef) {
        ...
        this.clampBounds = function (value) {
            return Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["c"])(_this.min, value, _this.max);
        };
        ...
        this.handleKeyboard = function (knob, isIncrease) {
            ...
            if (knob === 'A') {
                _this.ratioA = Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["c"])(0, _this.ratioA + step, 1);
            }
            else {
                _this.ratioB = Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["c"])(0, _this.ratioB + step, 1);
            }
            _this.updateValue();
        };
    ...
    Range.prototype.debounceChanged = function () {
        this.ionChange = Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["d"])(this.ionChange, this.debounce);
    };
    ...
    Range.prototype.onStart = function (detail) {
        ...
        var ratio = Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["c"])(0, (currentX - rect.left) / rect.width, 1);
        if (document.dir === 'rtl') {
            ratio = 1 - ratio;
        }
        this.pressedKnob =
    ...
    Range.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], { onFocusin: this.onFocus, onFocusout: this.onBlur, class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_3__chunk_ba834eff_js__["a" /* c */])(this.color), (_b = {}, _b[mode] = true, _b['in-item'] = Object(__WEBPACK_IMPORTED_MODULE_3__chunk_ba834eff_js__["c" /* h */])('ion-item', el), _b['range-disabled'] = disabled, _b['range-pressed'] = pressedKnob !== undefined, _b['range-has-pin'] = pin, _b)) }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "start" }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "range-slider", ref: function (rangeEl) { return _this.rangeSlider = rangeEl; } }, ticks.map(function (tick) { return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { style: tickStyle(tick), role: "presentation", class: {
                'range-tick': true,
                'range-tick-active': tick.active
            } })); }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "range-bar", role: "presentation" }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "range-bar range-bar-active", role: "presentation", style: barStyle }), renderKnob(isRTL, {
            knob: 'A',
            ...
            min: min,
            max: max
        })), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "end" })));
    };
...
var renderKnob = function (isRTL, _a) {
    ...
    return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { onKeyDown: function (ev) {
            var key = ev.key;
        ...
        }, style: knobStyle(), role: "slider", tabindex: disabled ? -1 : 0, "aria-valuemin": min, "aria-valuemax": max, "aria-disabled": disabled ? 'true' : null, "aria-valuenow": value }, pin && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "range-pin", role: "presentation" }, Math.round(value)), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "range-knob", role: "presentation" })));
};
var ratioToValue = function (ratio, min, max, step) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["c"])(min, value, max);
};
var valueToRatio = function (value, min, max) {
    return Object(__WEBPACK_IMPORTED_MODULE_4__chunk_c90aaa66_js__["c"])(0, (value - min) / (max - min), 1);
};
