...
var Toast = /** @class */ (function () {
    function Toast(hostRef) {
         ...
         */
        this.animated = true;
        this.didPresent = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionToastDidPresent", 7);
        this.willPresent = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionToastWillPresent", 7);
        this.willDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionToastWillDismiss", 7);
        this.didDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionToastDidDismiss", 7);
    }
    /**
    ...
    Toast.prototype.present = function () {
        return __WEBPACK_IMPORTED_MODULE_0_tslib__["__awaiter"](this, void 0, void 0, function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["e" /* d */])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position)];
                    case 1:
                        _a.sent();
                        if (this.duration > 0) {
    ...
    Toast.prototype.dismiss = function (data, role) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["f" /* e */])(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
    };
    /**
     * Returns a promise that resolves when the toast did dismiss.
     */
    Toast.prototype.onDidDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["g" /* f */])(this.el, 'ionToastDidDismiss');
    };
    /**
     * Returns a promise that resolves when the toast will dismiss.
     */
    Toast.prototype.onWillDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["g" /* f */])(this.el, 'ionToastWillDismiss');
    };
    ...
    Toast.prototype.hostData = function () {
        ...
        return {
            ...
            class: Object.assign((_a = {}, _a[mode] = true, _a), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["a" /* c */])(this.color), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["b" /* g */])(this.cssClass), { 'toast-translucent': this.translucent })
        };
    };
    Toast.prototype.renderButtons = function (buttons, side) {
        ...
        var buttonGroupsClasses = (_a = {
            ...
            _a);
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: buttonGroupsClasses }, buttons.map(function (b) { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: function () { return _this.buttonClick(b); } }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toast-button-inner" }, b.icon &&
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-icon", { name: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-icon" }), b.text), mode === 'md' && Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })); })));
    };
    Toast.prototype.__stencil_render = function () {
        ...
        var wrapperClass = (_a = {
            ...
            _a);
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: wrapperClass }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toast-container" }, this.renderButtons(startButtons, 'start'), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toast-content" }, this.header !== undefined &&
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toast-header" }, this.header), this.message !== undefined &&
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toast-message", innerHTML: Object(__WEBPACK_IMPORTED_MODULE_5__chunk_cae2ca23_js__["a" /* s */])(this.message) })), this.renderButtons(endButtons, 'end'))));
    };
    ...
    Toast.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
...
var buttonClass = function (button) {
    var _a;
    return Object.assign((_a = { 'toast-button': true, 'toast-button-icon-only': button.icon !== undefined && button.text === undefined }, _a["toast-button-" + button.role] = button.role !== undefined, _a['ion-focusable'] = true, _a['ion-activatable'] = true, _a), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["b" /* g */])(button.cssClass));
};
