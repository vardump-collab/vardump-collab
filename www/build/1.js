...
var App = /** @class */ (function () {
    ...
    App.prototype.componentDidLoad = function () {
        Object(__WEBPACK_IMPORTED_MODULE_5__chunk_c90aaa66_js__["a"])(function () {
            if (!__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('_testing')) {
                __webpack_require__.e/* import() */(110/* duplicate */).then(__webpack_require__.bind(null, 774)).then(function (module) { return module.startTapClick(__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"]); });
            }
            if (__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('statusTap', Object(__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["f" /* i */])(window, 'hybrid'))) {
                __webpack_require__.e/* import() */(112/* duplicate */).then(__webpack_require__.bind(null, 775)).then(function (module) { return module.startStatusTap(); });
            }
            if (__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('inputShims', needInputShims())) {
                __webpack_require__.e/* import() */(113/* duplicate */).then(__webpack_require__.bind(null, 776)).then(function (module) { return module.startInputShims(__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"]); });
            }
            __webpack_require__.e/* import() */(114/* duplicate */).then(__webpack_require__.bind(null, 777)).then(function (module) { return module.startFocusVisible(); });
        });
    };
    App.prototype.hostData = function () {
        ...
        return {
            class: (_a = {},
                _a[mode] = true,
                _a['ion-page'] = true,
                _a['force-statusbar-padding'] = __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('_forceStatusbarPadding'),
                _a)
        };
    };
    ...
    App.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData()); };
...
var needInputShims = function () {
    return Object(__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["f" /* i */])(window, 'ios') && Object(__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["f" /* i */])(window, 'mobile');
};
var Buttons = /** @class */ (function () {
    ...
    Buttons.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData()); };
...
var Content = /** @class */ (function () {
    function Content(hostRef) {
        ...
        this.ionScrollStart = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionScrollStart", 7);
        this.ionScroll = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionScroll", 7);
        this.ionScrollEnd = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionScrollEnd", 7);
    }
    Content.prototype.componentWillLoad = function () {
        if (this.forceOverscroll === undefined) {
            var mode = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["d" /* c */])(this);
            this.forceOverscroll = mode === 'ios' && Object(__WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["f" /* i */])(window, 'mobile');
        }
    };
    ...
    Content.prototype.resize = function () {
        if (this.fullscreen) {
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["g" /* f */])(this.readDimensions.bind(this));
        }
    ...
    Content.prototype.onScroll = function (ev) {
        ...
        if (!this.queued && this.scrollEvents) {
            this.queued = true;
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["g" /* f */])(function (ts) {
                _this.queued = false;
    ...
    Content.prototype.render = function () {
        ...
        this.resize();
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], { class: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["a" /* c */])(this.color), (_a = {}, _a[mode] = true, _a['content-sizing'] = Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["c" /* h */])('ion-popover', this.el), _a['overscroll'] = !!this.forceOverscroll, _a)), style: {
                '--offset-top': this.cTop + "px",
                '--offset-bottom': this.cBottom + "px",
            } }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                'overscroll': (scrollX || scrollY) && !!forceOverscroll
            }, ref: function (el) { return _this.scrollEl = el; }, onScroll: function (ev) { return _this.onScroll(ev); } }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", null)), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "fixed" })));
    };
...
var Footer = /** @class */ (function () {
    ...
    Footer.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData()); };
...
var Header = /** @class */ (function () {
    ...
    Header.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData()); };
...
var RouterOutlet = /** @class */ (function () {
    function RouterOutlet(hostRef) {
        ...
        this.ionNavWillChange = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionNavWillChange", 3);
        this.ionNavDidChange = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionNavDidChange", 3);
    }
        ...
        return __WEBPACK_IMPORTED_MODULE_0_tslib__["__awaiter"](this, void 0, void 0, function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, __webpack_require__.e/* import() */(109/* duplicate */).then(__webpack_require__.bind(null, 773))];
                    case 1:
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__chunk_00265c49_js__["a"])(this.delegate, this.el, component, ['ion-page', 'ion-page-invisible'], params)];
                    case 1:
                        enteringEl = _a.sent();
                    ...
                    case 2:
                        // commit animation
                        _a.sent();
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__chunk_00265c49_js__["b" /* d */])(this.delegate, leavingEl)];
                    case 3:
                        _a.sent();
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        animated = this.animated && __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].getBoolean('animated', true);
                        animationBuilder = this.animation || opts.animationBuilder || __WEBPACK_IMPORTED_MODULE_2__chunk_1074393c_js__["b"].get('navAnimation');
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_7__chunk_638b009b_js__["d" /* t */])(Object.assign({ mode: mode,
                                animated: animated,
...
var ToolbarTitle = /** @class */ (function () {
    ...
    ToolbarTitle.prototype.hostData = function () {
        ...
        return {
            class: Object.assign((_a = {}, _a[mode] = true, _a["title-" + mode] = true, _a), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["a" /* c */])(this.color))
        };
    };
    ToolbarTitle.prototype.__stencil_render = function () {
        return [
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toolbar-title" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", null))
        ];
    };
    ...
    ToolbarTitle.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], { class: Object.assign((_a = {}, _a[mode] = true, _a), childStyles, Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["a" /* c */])(this.color)) }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toolbar-background" }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toolbar-container" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "start" }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "secondary" }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "toolbar-content" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", null)), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "primary" }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("slot", { name: "end" }))));
    };
