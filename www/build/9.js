...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__chunk_4e92c885_js__ = __webpack_require__(770);
...
var Datetime = /** @class */ (function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["n" /* p */].create(pickerOptions)];
                    case 1:
                        picker = _a.sent();
                        ...
                        picker.addEventListener('ionPickerColChange', function (event) { return __WEBPACK_IMPORTED_MODULE_0_tslib__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        selectedIndex = column.selectedIndex = Object(__WEBPACK_IMPORTED_MODULE_5__chunk_c90aaa66_js__["c"])(indexMin, column.selectedIndex, indexMax);
    ...
    Datetime.prototype.render = function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_5__chunk_c90aaa66_js__["k" /* r */])(true, el, this.name, this.value, this.disabled);
        return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": "" + isExpanded, "aria-haspopup": "true", "aria-labelledby": labelId, class: (_a = {},
                _a[mode] = true,
                ...
                _a) }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "datetime-text" }, datetimeText), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: function (btnEl) { return _this.buttonEl = btnEl; } })));
    };
...
var Picker = /** @class */ (function () {
    function Picker(hostRef) {
         ...
         */
        this.animated = true;
        this.didPresent = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionPickerDidPresent", 7);
        this.willPresent = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionPickerWillPresent", 7);
        this.willDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionPickerWillDismiss", 7);
        this.didDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionPickerDidDismiss", 7);
    }
    ...
    Picker.prototype.present = function () {
        return __WEBPACK_IMPORTED_MODULE_0_tslib__["__awaiter"](this, void 0, void 0, function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["e" /* d */])(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined)];
                    case 1:
                        _a.sent();
                        if (this.duration > 0) {
    ...
    Picker.prototype.dismiss = function (data, role) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["f" /* e */])(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
    };
    /**
     * Returns a promise that resolves when the picker did dismiss.
     */
    Picker.prototype.onDidDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["g" /* f */])(this.el, 'ionPickerDidDismiss');
    };
    /**
     * Returns a promise that resolves when the picker will dismiss.
     */
    Picker.prototype.onWillDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["g" /* f */])(this.el, 'ionPickerWillDismiss');
    };
    /**
    ...
    Picker.prototype.buttonClick = function (button) {
        ...
        var shouldDismiss = Object(__WEBPACK_IMPORTED_MODULE_3__chunk_d83bfeae_js__["o" /* s */])(button.handler, this.getSelected()) !== false;
        if (shouldDismiss) {
            return this.dismiss();
        }
    ...
    Picker.prototype.hostData = function () {
        ...
        return {
            ...
            _a["picker-" + mode] = true, _a), Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["b" /* g */])(this.cssClass)),
            style: {
    ...
    Picker.prototype.__stencil_render = function () {
        ...
        return [
            ...
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-wrapper", role: "dialog" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-toolbar" }, this.buttons.map(function (b) { return (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: buttonWrapperClass(b) }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("button", { type: "button", onClick: function () { return _this.buttonClick(b); }, class: buttonClass(b) }, b.text))); })), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-columns" }, Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-above-highlight" }), this.presented && this.columns.map(function (c) { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("ion-picker-column", { col: c }); }), Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-below-highlight" })))
        ];
    };
    ...
    Picker.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
...
var buttonClass = function (button) {
    return Object.assign({ 'picker-button': true, 'ion-activatable': true }, Object(__WEBPACK_IMPORTED_MODULE_4__chunk_ba834eff_js__["b" /* g */])(button.cssClass));
};
/**
 * @internal
 */
var PickerColumnCmp = /** @class */ (function () {
    function PickerColumnCmp(hostRef) {
        ...
        this.y = 0;
        this.noAnimate = true;
        this.ionPickerColChange = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["e" /* d */])(this, "ionPickerColChange", 7);
    }
            ...
            return __WEBPACK_IMPORTED_MODULE_0_tslib__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.refresh();
                        _a = this;
                        return [4 /*yield*/, __webpack_require__.e/* import() */(108/* duplicate */).then(__webpack_require__.bind(null, 766))];
                    case 1:
    ...
    PickerColumnCmp.prototype.update = function (y, duration, saveY) {
        ...
        if (this.lastIndex !== selectedIndex) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_6__chunk_4e92c885_js__["b"])();
    ...
    PickerColumnCmp.prototype.onEnd = function (detail) {
        ...
        this.velocity = Object(__WEBPACK_IMPORTED_MODULE_5__chunk_c90aaa66_js__["c"])(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    PickerColumnCmp.prototype.refresh = function (forceRefresh) {
        ...
        var selectedIndex = Object(__WEBPACK_IMPORTED_MODULE_5__chunk_c90aaa66_js__["c"])(min, this.col.selectedIndex || 0, max);
    ...
    PickerColumnCmp.prototype.__stencil_render = function () {
        ...
        var Button = 'button';
        return [
            col.prefix && (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)),
            Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: function (el) { return _this.optsEl = el; } }, col.options.map(function (o, index) { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text); })),
            col.suffix && (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))
        ];
    };
    ...
    PickerColumnCmp.prototype.render = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__chunk_09ec7fc0_js__["a" /* H */], this.hostData(), this.__stencil_render()); };
