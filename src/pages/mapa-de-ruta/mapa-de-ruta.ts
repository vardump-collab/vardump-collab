...
export class MapaDeRutaPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public alert: AlertController,private authInstance: AngularFireAuth, public dom: DomSanitizer) 
  {
